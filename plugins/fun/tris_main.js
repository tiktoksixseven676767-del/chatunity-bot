...
let handler = async (m, { conn, text, usedPrefix, command }) => {
    ...
    if (command === 'tris') {
        ...
        // 🖼️ L'IMMAGINE DELLA LAVAGNA (Quella del video!)
        await conn.sendMessage(chatId, { 
            image: { url: 'https://static.vecteezy.com/ti/vettori-gratis/p3/6409900-tic-tac-toe-sketched-isolato-gioco-vintage-in-stile-disegnato-a-mano-vettoriale.jpg' },
